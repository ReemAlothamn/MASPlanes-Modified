...
public class Block {
    ...
    private boolean assignToPlane=false;
    ...
    public enum blockState {
        ...
        EMPTY , PENDING, OK, UNEXPLORED
    }

    private blockState state;
    
    
    private boolean hasAbeacon=false;
    
    
    public boolean ithasAbeacon(){
    return hasAbeacon;
    }
    
    
    public void setBeacon(boolean b){
    hasAbeacon=b;    
    }
    ...
    public void setassignToPlane(boolean a){assignToPlane=a;}
    
    public boolean getassignToPlane(){return assignToPlane;}
